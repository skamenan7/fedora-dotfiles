/*!
 * ====================================================
 * kityminder-editor - v1.0.64 - 2025-04-09
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        imagehint: "Výzva:",
                        placeholder3: "Volitelné: text, který se zobrazí při najetí myší na obrázek",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "Volitelné: Text, který se zobrazí při najetí myší na odkaz",
                        ok: "Tak určitě",
                        cancel: "zrušení"
                    },
                    exportnode: {
        ...
        return module.exports = {
            ...
            ui: {
                ...
                noteeditor: {
                    ...
                    placeholder: "Kérjük, válassza ki a csomópontot a jegyzetek szerkesztéséhez"
                },
                dialog: {
                    image: {
                        title: "kép",
                        ...
                        placeholder3: "Nem kötelező: szöveg, amely akkor jelenik meg, amikor az egérmutatót a kép fölé viszi",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "Választható: Szöveg, amely kéri, ha az egérmutatót a hivatkozás fölé viszi",
                        ok: "biztos",
                        cancel: "Megszünteti"
                    },
                    exportnode: {
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        imagehint: "プロンプトテキスト:",
                        placeholder3: "オプション: 画像上にマウスを置いたときにプロンプトが表示されるテキスト",
                        preview: "画像プレビュー:",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "オプション: リンク上にマウスを置いたときにプロンプトを表示するテキスト",
                        ok: "もちろん",
                        cancel: "キャンセル"
                    },
                    exportnode: {
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        imagehint: "프롬프트 텍스트:",
                        placeholder3: "선택사항: 마우스를 이미지 위로 가져갈 때 표시되는 텍스트",
                        preview: "그림 미리보기:",
                        uploadimage: "이미지 업로드",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "선택 사항: 링크 위에 마우스를 올리면 메시지가 표시되는 텍스트",
                        ok: "확신하는",
                        cancel: "취소"
                    },
                    exportnode: {
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        placeholder3: "Opcjonalnie: tekst wyświetlany po najechaniu myszką na obraz",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "Opcjonalnie: Tekst wyświetlający monit po najechaniu myszką na łącze",
                        ok: "Jasne",
                        cancel: "Anulować"
                    },
                    exportnode: {
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        placeholder3: "Opcional: texto a ser solicitado quando o mouse passar sobre a imagem",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "Opcional: texto a ser solicitado quando o mouse passa sobre o link",
                        ok: "Claro",
                        cancel: "Cancelar"
                    },
                    exportnode: {
            ...
            ui: {
                ...
                dialog: {
                    image: {
                        ...
                        placeholder3: "Необязательно: текст, который будет запрашиваться при наведении курсора мыши на изображение.",
                    ...
                    hyperlink: {
                        ...
                        placeholder2: "Необязательно: текст запроса при наведении указателя мыши на ссылку.",
                        ok: "Конечно",
                        cancel: "Отмена"
                    },
                    exportnode: {
